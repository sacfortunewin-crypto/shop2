...
module.exports = async function handler(req, res) {
  ...
  console.log("[checkout:client-tracking]", {
    ...
    storage: {
      localFound: Boolean(input.storage && input.storage.localFound),
      sessionFound: Boolean(input.storage && input.storage.sessionFound),
      cookieFound: Boolean(input.storage && input.storage.cookieFound),
    },
